...
@section('content')
    <div class="row">
        <form action="{{ route('products.update', $prod['id']) }}" enctype="multipart/form-data" method="POST" class="create-category container-fluid">
            {{ csrf_field() }}
            {{ method_field("PUT") }}
                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="nome" name="name" value="{{ $prod['name'] }}" placeholder="Nome do Produto"/>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <input type="text" class="form-control" name="sku" value="{{ $prod['sku'] }}" id="sku" placeholder="SKU do Produto"/>
                            </div>

                            <label for="preco" class="col-sm-2 control-label">Preço</label>

                            <div class="col-sm-4">
                                <input type="text" class="form-control" name="price" value="{{ $prod['price'] }}" id="nome" placeholder="Preço"/>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <textarea name="description" id="descricao" class="form-control" rows="5">{{ $prod['description'] }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="box-body">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <select id="categoria" name="category" class="form-control select2" style="width: 100%;">
                                    ...
                                    <option value="roupas" {{ $prod['category'] === "roupas" ? "selected" : "" }}>Roupas</option>
                                    <option value="calcados" {{ $prod['category'] === "calcados" ? "selected" : "" }}>Calçados</option>
                                    <option value="acessorios" {{ $prod['category'] === "acessorios" ? "selected" : "" }}>Acessórios</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            <div class="col-sm-12 text-right">
                                <button type="submit" class="btn btn-primary btn-flat">Alterar Produto</button>
